...
for seed in 100 101; do
    for query_score_pooling in "MAX"; do
        for query_batch_size in 10; do
            for query_strategy in "RANDOM_SAMPLING" "COARSE_UNCERTAINTY_MEASURE" "COARSE_ENTROPY_MEASURE" "FINE_UNCERTAINTY_MEASURE" "FINE_ENTROPY_MEASURE" "GROUPED_FINE_ENTROPY"; do
